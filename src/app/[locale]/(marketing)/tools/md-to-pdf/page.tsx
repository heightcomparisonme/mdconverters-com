...
export const metadata: Metadata = {
  ...
  description:
    'Convert your Markdown content to beautifully formatted PDF documents with syntax highlighting and custom styling.',
};
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Transform your Markdown documents into professional PDF files with
            syntax highlighting, custom styling, and full formatting support.
          </p>
        </div>
